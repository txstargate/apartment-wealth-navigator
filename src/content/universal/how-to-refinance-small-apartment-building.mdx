...
pillar: refinance
youtubeId: "H-ypmt3DUDA"
dcCounterpart: refinance-dc-apartment-building
publishDate: 2026-09-08
draft: false
inlineCtas: true
coverImage: ../../assets/covers/how-to-refinance-small-apartment-building.jpg
coverAlt: "An illustration of a brick building beside two gauges labelled value and coverage"
faq:
  - question: "How do lenders decide how much to lend on an apartment building?"
    answer: "Lenders size a loan two ways and take the lower: a value test capping the loan near 75 percent of appraised value, and a coverage test requiring NOI to cover the mortgage payment by about 1.25 times. The coverage test usually controls on small buildings."
  - question: "Why is my refinance appraisal lower than expected?"
    answer: "A lender rebuilds your income before pricing it: full-occupancy rent minus a standard vacancy factor, normalized expenses, a management fee even if you self-manage, and replacement reserves. Each adjustment lowers NOI, and a lower NOI lowers both the value and the loan."
  - question: "How much loan does each dollar of NOI support?"
    answer: "At a 1.25 coverage floor and 25-year amortization, roughly $10,000 of borrowing capacity for every $1,000 of defensible NOI. That is why protecting income year-round, not just before a refinance, decides your proceeds."
  - question: "When should I start preparing to refinance?"
    answer: "Eighteen months before maturity. Run the lender's math at 18 months, fix and document at 12, assemble the package and shop lenders at 6, and execute at 90 days with options in hand."
---
...
The package as a printable checklist, with the question each section answers for the lender: [get the Lender-Ready Package Checklist](/refinance-readiness/).
