...
That single calculation tells you which of the next three moves is available to you. The same arithmetic is on one printable page, and I will run it on your building as a three-number range: [get your value range](/value-navigator/).
